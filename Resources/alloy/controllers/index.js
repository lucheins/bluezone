function Controller() {
    ...
    __alloyId12.push($.__views.vistaChrono);
    ...
    __alloyId12.push($.__views.vistaDistance);
    ...
    __alloyId13.push($.__views.scrollView);
    ...
    $.__views.alarma.add($.__views.__alloyId14);
    ...
    $.__views.restante.add($.__views.__alloyId15);
    ...
    $.__views.velocidad.add($.__views.__alloyId16);
    ...
    __alloyId13.push($.__views.scrollView2);
    ...
    $.__views.llegada.add($.__views.__alloyId17);
    ...
    $.__views.altitud.add($.__views.__alloyId18);
    ...
    $.__views.hora.add($.__views.__alloyId19);
    ...
    $.start.addEventListener("click", function() {
        ...
        if (testigo_hora_comienzo_carrera) {
            ...
            var pin_inicio = Titanium.Map.createAnnotation({
                latitude: lat,
                longitude: lng,
                title: "Auto",
    ...
    $.buscar.addEventListener("click", function() {
        ...
        var client = Ti.Network.createHTTPClient({
            onload: function() {
                ...
                testigo_pines_inicio_mapa = true;
                var pin_final = Titanium.Map.createAnnotation({
                    latitude: lat,
                    longitude: lng,
                    title: "Inicio",
    ...
    $.satellite.addEventListener("click", function() {
        mapview.mapType = mapview.mapType == Titanium.Map.STANDARD_TYPE ? Titanium.Map.SATELLITE_TYPE : Titanium.Map.STANDARD_TYPE;
    });
    var cada_km = 0;
    var cuantos_km = 0;
